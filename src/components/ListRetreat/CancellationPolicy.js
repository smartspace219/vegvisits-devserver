...
class CancellationPolicy extends Component {
    ...
    renderFormControlRadioButton = ({input: { value, onChange }, id, fieldName, label, meta: { touched, error }, children, className,}) => {
                                ...
                                <div>
                                    <FormGroup className={s.formGroup}>
                                        ...
                                        <Field name="cancellationPolicy" component={this.renderFormControlSelect} className={cx(s.formControlSelect, s.jumboSelect)} >
                                            {
                                                cancellationType.map((value, key) => {
                                                    return (
                                                        value.isEnable == 1 && <option value={value.itemName} key={key}>{value.itemName}</option>
                                                    )
                                                })
                                            }
                                        </Field>
