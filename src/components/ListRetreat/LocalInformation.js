...
class LocalInformation extends Component {
    ...
    renderFormControlCheckbox = ({ input: { value, onChange }, id, label, meta: { touched, error }, children, className }) => {
        ...
        return (
            <Checkbox id={id} inline onChange={e => {
                ...
                onChange(newValue)
            }} className={s.retreatCheckbox}>{label}</Checkbox>
        )
    }
    ...
    render() {
        ...
        const { localInformation, facilityFeatures } = this.state;
                        ...
                        <FormGroup>
                            {
                                localInformation.map((each, index) => (
                                    <Field id={each.id} key={index} name="localInformation" component={this.renderFormControlCheckbox} label={each.name} />
                                ))
                            }
                        </FormGroup>
                    </Col>
                        ...
                        <FormGroup>
                            {
                                facilityFeatures.map((each, index) => (
                                    <Field id={each} key={index} name="facilityFeatures" component={this.renderFormControlCheckbox} label={each} />
                                ))
                            }
                        </FormGroup>
                    </Col>
