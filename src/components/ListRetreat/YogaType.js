                                        ...
                                        <Row className="show-grid">
                                            {
                                                yogaType.map((each, index) => (
                                                    <Field id={each.id} key={index} name="yogaTypes" component={this.renderFormControlCheckbox} label={each.itemName} />
                                                ))
                                            }
                                        </Row>
                                    </Grid>
